...
namespace CodeAndTravel.Controllers
{
    public class PromocoesController : Controller
    {
        private readonly ContextClass _context;

        public PromocoesController(ContextClass context)
        {
            _context = context;
        }
        ...
        {
            var contextClass = _context.Promocoes.Include(p => p.Destino);
            return View(await contextClass.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,Nome,DestinoID,Descricao,Desconto")] Promocao promocao)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Nome,DestinoID,Descricao,Desconto")] Promocao promocao)
        {
            if (id != promocao.ID)
            {
                return NotFound();
